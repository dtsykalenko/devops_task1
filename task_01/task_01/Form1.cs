...
namespace task_01
{
    public partial class Form1 : Form
    {
        ...
        int k; //кількість натискань кнопки MRC
        ...
        //видаляємо зайвий нуль попереду числа, якщо такий є
        ...
        //кнопка Корінь довільного ступеня
        ...
        //кнопка Зведення в довільний ступінь
        ...
        //перевіряє чи ще не натиснена яка-небудь з кнопок мат.операцій
        ...
        //зняття натискання всіх кнопок мат.операцій
